...
class NewShoppingItemDialogFragment : DialogFragment() {
    ...
    /** callback interface-t, amelyen keresztül a dialógust megjelenítő Activity értesülhet az új elem létrehozásáról. **/
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        /** A dialógust itt állítjuk elő. **/
        return AlertDialog.Builder(requireContext())
            .setTitle(R.string.new_shopping_item)
            .setView(binding.root)
            .setPositiveButton(R.string.button_ok) { dialogInterface, i ->
                if (isValid()) {
                    /** MainActivityben lévő függvényt meghívja, hogy berakja az új shopping itemet **/
    ...
    /** Akkor valid az hozzáadás a dialogból ha a név nem üres  **/
